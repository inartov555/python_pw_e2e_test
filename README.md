...
7. Run the `run_tests.sh` file next way: `run_tests.sh $PATH_TO_INI_CONFIG` (if you don't pass the ini config file, then the default one is used [`pytest.ini`](./pytest.ini)). 
